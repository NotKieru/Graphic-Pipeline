...
def create_cone(radius1, radius2, height, num_points=30):
    ...
    for i in range(num_points):
        ...
        # Faces laterais
        faces.append({'vertices': [i, next_i, num_points + next_i], 'color': 'black'})
        faces.append({'vertices': [i, num_points + next_i, num_points + i], 'color': 'black'})
    ...
    for i in range(num_points):
        ...
        faces.append({'vertices': [base1_start + i, base1_start + next_i, base1_start], 'color': 'black'})
        # Face da base superior
        faces.append({'vertices': [base2_start + i, base2_start + next_i, base2_start], 'color': 'black'})
